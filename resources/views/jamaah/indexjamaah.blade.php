    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        ...
        <div class="card card-info card-outline">
          ...
          <div class="card-body">
            <a href="createjamaah" class="btn btn-success">Tambah Data</a>
            ...
            <table class="table">
              ...
              <tbody>
                @foreach($jamaah as $index=> $i)
                <tr>
                  <td>{{$index+$jamaah->firstitem()}}</td>
                  ...
                  <td>{{$i->golongan}}</td>
                  <td>
                    <a href='/editjamaah/{{$i->id}}' class="btn btn-info"><i class="fa fa-pencil"></i></a>
                    <a href='/deletejamaah/{{$i->id}}' class="btn btn-danger"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
