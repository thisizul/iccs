          ...
          <div class="card-body">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">
                  <i class="fa fa-edit"></i> Tambah Data Jamaah
                </h3>
              </div>
              <form action="/storejamaah" method="post">
                {{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nama Kepala Keluarga</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="nama_kk" name="nama_kk" placeholder="Nama Kelapa Keluarga" required>
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer">
                  ...
                  <a href='/jamaah' title="Kembali" class="btn btn-secondary">Batal</a>
                </div>
              </form>
            </div>
          </div>
