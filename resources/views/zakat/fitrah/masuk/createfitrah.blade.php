          ...
          <div class="card-body">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">
                  <i class="fa fa-edit"></i> Tambah Zakat Fitrah
                </h3>
              </div>
              <form action="/simpanfitrah" method="post">
                {{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Muzakki</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Muzakki" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="jumlahjiwa" name="jumlahjiwa" placeholder="Jumlah Jiwa" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Jenis</label>
                    <div class="col-sm-4">
                      <select type="text" class="form-control" id="jenis" name="jenis" placeholder="Jumlah Jiwa" required>
                        @error('tipe')
