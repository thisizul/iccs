...
<body class="hold-transition sidebar-mini">
        ...
        <div class="card card-info card-outline">
          <div class="card-body">
            <div class="card card-primary">
              ...
              <form method="POST" name="myform" action="/simpankasmasjid/{{$kas->id}}">
                {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" value="{{$kas->masuk}}" class="form-control" id="masuk" name="masuk" placeholder="Jumlah Pemasukan" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <select type="text" value="{{$kas->tipe}}" class="form-control" id="tipe" name="tipe" placeholder="tipe" required>
                        ...
                        <option value="Infaq Jum'at">Infaq Jum'at</option>
  ...
  <script>
    var rupiah1 = document.getElementById("masuk");
